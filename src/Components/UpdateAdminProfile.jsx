...
const Popup = (props) => {
    ...
    const updatingForm = async (id) => {
        const res = await axios.get(`https://10.1.2.201/api/facedetection/admin/details/${id}`);
    ...
    const handleClickOpen = (id) => {
        ...
        async function preview() {
            const response = await axios.get(
                `https://10.1.2.201/api/facedetection/admin/picture/${id}`,
                {
    ...
    function handleSubmit(event) {
        ...
        axios
            .put(
                `https://10.1.2.201/api/facedetection/admin/update/${iaId}?iaId=${iaId}&vin=${vechin}&firstName=${firstname}&lastName=${lastname}&email=${email}&password=${pass}&phoneNo=${phone}`,
                formData,
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <form style={{ backgroundColor: "#fff" }} onSubmit={handleSubmit}>
                    <div className="input-group">
                        <label>AdminID:</label>
                        <input type="number" name="iaId" value={id} readOnly />
                    </div>
                    <div className="input-group">
